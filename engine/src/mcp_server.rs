...
fn main() {
    ...
    let db = Database::open_and_return("data/encorehub.db").expect("Failed to open database");
...
fn handle_tools_list(req: &JsonRpcRequest) -> JsonRpcResponse {
    let tools = vec![
        ...
        Tool {
            ...
            description: "Search conversation memories (both conversation-scoped and global)"
                .into(),
            input_schema: serde_json::json!({
                "type": "object",
                "properties": {
